...
3) Access the `workbench` named `mar20-testnewgitops-chatbot-notebook`.
...
5) In the terminal, run `cd mar20-testnewgitops-chatbot` to navigate to your sample app's directory.
